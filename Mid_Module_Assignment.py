...
def floyd(*args):
    ...
    r is used to parse the nv or matrix macximum dimension declared above 
    ...
    for r in range(nv):  # p and q and invoked and are used as varaibles indecies for colm and row respectivl. r is used to parse the nv or matrix maximum dimension declared above
        for p in range(nv):
            for q in range(nv):
...
def sol(dist):
    ...
    n and p and invoked and are used as varaibles indecies for colm and row respectivly  
    ...
    """
    for p in range(nv):    #p and q and invoked and are used as varaibles indecies for colm and row respectivly 
        for q in range(nv):
            if(dist[p][q] == INF):
                print("INF", end=" ")
            else:
